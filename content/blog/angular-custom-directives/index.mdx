---
id: 'c3d4fee41d02468a88b6d6016a4d3e36'
...
In this tutorial, you will learn what angular attribute direcitves are and how to create custom direcitves.

We will discover how to use directives to alter the appearance of DOM-element, react to user input and how to pass input to direcitves.

In the process it will also become apparent when to use a angular direcive vs a component.

...
recommended: ["5bb0cae79583501f642526f6","5bb0cae79583501f642526fb","5bb0cae79583501f64252702"]
tags: ["angular"]
---
...
["](http://redux.js.org/docs/introduction/ThreePrinciples.html)[The only way to change the state is to emit an ](http://redux.js.org/docs/introduction/ThreePrinciples.html)[action](http://redux.js.org/docs/introduction/ThreePrinciples.html)[, an object describing what happened."](http://redux.js.org/docs/introduction/ThreePrinciples.html)
...
Pure Functions
We will later learn, that we can not only make requests in form of actions, but can also react to an action. For that, we will register a reducer. This reducer is a [pure function](https://medium.com/@jamesjefferyuk/javascript-what-are-pure-functions-4d4d5392d49c). That means, it takes the state, makes a copy of it and then applies the changes to the copy.
...
Using the state in our components is fortunately quite simple. That is when you are comfortable with RxJs. If not, I recommend rading my [guide on RxJs especially designed for angular developers](https://malcoded.com/posts/rxjs-for-angular-devs).
